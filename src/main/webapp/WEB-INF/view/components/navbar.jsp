<nav class="navbar navbar-expand-lg navbar-light custom-bg">
  <a class="navbar-brand" href="/home">
   ...
   <i><b><span class="text-color">MediSched</span></b></i>
  </a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="resources/images/phonee.png" style="width:27px;" alt="img">+91 6394000111<br>
                <img src="resources/images/emaill.png" style="width:29px;" alt="img">aliyakhanaliya333@gmail.com
            </b>
        </p>
        </div>
      </div>
